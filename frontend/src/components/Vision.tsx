...
export default function Vision() {
  return (
    <section className="relative bg-[#05090C] py-40 px-6 md:px-16 overflow-hidden min-h-screen flex flex-col justify-center border-t border-white/[0.03]">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        >
          <h2 className="heading-premium text-6xl md:text-[140px] leading-[0.9] mb-16">
            ...
            Every Decision <span className="text-white">Data-Driven.</span>
          </h2>
        ...
        <motion.div 
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="mt-32 pt-16 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-10"
        >
          <div className="font-display text-white text-3xl font-black tracking-[0.2em] uppercase">SCHOLARS<span className="text-primary">.NG</span></div>
          <div className="flex flex-col md:flex-row gap-12 text-gray-500 font-display font-black text-xs uppercase tracking-[0.2em]">
            <a href="mailto:invest@scholars.ng" className="hover:text-gold transition-colors underline decoration-white/5 underline-offset-8">invest@scholars.ng</a>
            <a href="https://scholars.ng" className="hover:text-gold transition-colors underline decoration-white/5 underline-offset-8">scholars.ng</a>
          </div>
        </motion.div>
      </div>
    </section>
